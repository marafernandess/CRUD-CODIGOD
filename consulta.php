...
<div class="row">
	<div class="container">
		...
		<table class="table"> <!-- mostra a tabela -->
			...
			<tbody>
				...
				<?php
                // ordem by nome: coloca por ordem do nome
				...
				<tr>
					...
					<td> <span style="font-size: 25px"><a href="alterar_dado.html"  class="far fa-edit "></a></span> </td>
